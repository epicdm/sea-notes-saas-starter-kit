...
/**
 * TTS Preview API Route
 *
 * Proxies TTS preview requests to the Flask backend.
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${flaskUrl}/api/testing/tts-preview`, {
      method: "POST",
      headers: {
    ...
    // Flask returns: { success: true, audio_data: "...", ... }
    ...
    console.error("Error proxying TTS preview request:", error);
