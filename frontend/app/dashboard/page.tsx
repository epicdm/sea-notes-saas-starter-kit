...
import { getDashboardStats, getCalls, DashboardStats, CallLog } from "@/lib/api";
...
export default function DashboardPage({ accessToken, onNavigate, onCreateAgent }: DashboardPageProps) {
